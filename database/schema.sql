...
INSERT INTO csc535_barber.`user` VALUES 
	-- (DEFAULT, 'csc535barberapp@tutamail.com', SHA('#3TestUser'), 'Test', 'Test', 'Barber', 1),
    -- (DEFAULT, 'csc535clientapp@mailfence.com', SHA('#3TestUser'), 'Test1', 'Client1', 'Client', 1),
...
INSERT INTO csc535_barber.`unavailable` VALUES
	(DEFAULT, 1, '2024-02-14', DEFAULT, DEFAULT),
    (DEFAULT, 1, DATE_ADD(DATE_ADD(CURDATE(), INTERVAL (7 - WEEKDAY(CURDATE())) + 1 DAY), INTERVAL 3 WEEK), DATE_ADD(DATE_ADD(CURDATE(), INTERVAL (7 - WEEKDAY(CURDATE())) + 1 DAY), INTERVAL 4 WEEK), DEFAULT);
